...
rownames(counts_resfinder_phy) <- c(1:3104) #PKY: Why hard-coded?
rownames(clusters_tax_table_resfinder) <- c(1:3104) #PKY: Why hard-coded?
...
rownames(resfinder_length_SSU_norm) <- c(1:3104) #PKY: Why hard-coded?
